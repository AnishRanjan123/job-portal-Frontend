...
const TalentCard = (props: any) => {
  ...
  return (
    // Change w-98 to a fixed width like w-80 or a responsive one like max-w-sm
    <div className="bg-mine-shaft-900 p-4 w-96 flex flex-col gap-2.5 rounded-xl hover:shadow-[0_0_5px_1px_yellow] !shadow-bright-sun-400">
      ...
      {props.invited ? (
        <div className="flex gap-1 text-mine-shaft-200 text-sm items-center">
          ...
          Interview: August 25,2025 00:00 AM
        </div>
      ) : (
        <div className="flex justify-between">
