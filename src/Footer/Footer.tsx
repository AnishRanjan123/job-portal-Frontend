...
//             <IconHandStop className="h-6 w-6" stroke={1.25} />
//             <div className="text-xl font-semibold">OneStop</div>
//           </div>
//           <div className="text-sm text-mine-shaft-300">
//             Job portal with user profiles , skill updates , certiifications,work
//             experiences and admin job posting.
//           </div>
