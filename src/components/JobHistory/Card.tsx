...
const Card = (props: any) => {
  return (
    <Link
      to="/jobs"
      className="bg-mine-shaft-900 p-4 w-72 flex flex-col gap-2.5 rounded-xl hover:shadow-[0_0_5px_1px_yellow] !shadow-bright-sun-400"
    >
      ...
      {/* FIXED Divider */}
      <Divider size="sm" className="border-mine-shaft-700" />
